...
de la misma clase que se recibe como parámetro en el m�todo de la functional interface, siempre que retornen el mismo tipo. 
...
En programacion funcional es un patron de diseño para construir tipos genéricos.

** En informática, una tuber�a (pipe, cauce o '|') consiste en una cadena de procesos conectados de forma tal que la salida de cada elemento
